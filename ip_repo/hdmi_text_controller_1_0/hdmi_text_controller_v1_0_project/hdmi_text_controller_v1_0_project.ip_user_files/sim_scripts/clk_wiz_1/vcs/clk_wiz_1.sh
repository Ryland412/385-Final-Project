...
#
# Generated by Vivado on Thu Oct 30 19:43:38 -0500 2025
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"$ref_dir/../../../ipstatic" +incdir+"$ref_dir/../../../../hdmi_text_controller_v1_0_project.gen/sources_1/ip/clk_wiz_1" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic" +incdir+"$ref_dir/../../../../hdmi_text_controller_v1_0_project.gen/sources_1/ip/clk_wiz_1" \
    "$ref_dir/../../../../hdmi_text_controller_v1_0_project.gen/sources_1/ip/clk_wiz_1/clk_wiz_1_clk_wiz.v" \
    "$ref_dir/../../../../hdmi_text_controller_v1_0_project.gen/sources_1/ip/clk_wiz_1/clk_wiz_1.v" \
  2>&1 | tee -a vlogan.log
